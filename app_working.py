...
def make_prediction(video_id = None, lang = '', container = 'var', published_date = None, primary = None, d_primary = None):
    st.write(f'Features from OD are maximum area percentage, most frequent label count, number of label in first 3 frame, most frequent label first 3 frame number')
...
########################################################################################
        ...
        if st.button("Make Prediction"):
            ...
            make_prediction(video_id = video_id, lang = lang, container = container, published_date = published_date, primary = primary, d_primary = d_primary)
